...
contract LockedStakingRewards is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard {
    ...
    function withdraw(uint256 amount) public nonReentrant updateReward(msg.sender) {
        ...
        require(block.timestamp >= periodFinish, "Cannot withdraw while locked");
